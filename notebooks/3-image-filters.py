...
def apply_pink(frame, intensity=0.5):
    blue, green, red = 204, 204, 255
    frame = cv2.cvtColor(frame, cv2.COLOR_BGR2BGRA)
    frame_height, frame_width, frame_channel = frame.shape
    pink_bgra = (blue, green, red, 1)
    
    overlay = np.full((frame_height, frame_width, 4), pink_bgra, dtype='uint8')
